...
int main()
{
    ...
    // test arbitrary value (timestamp here)
    double u = 0.5;
    double u1 = 0.15;
    double u2 = 0.25;
    double u3 = 0.45;
    double u4 = 0.75;
    double u5 = 0.85;
    // interpolate the pose from given the poses at 4 control points
    ...
    // minimal jacobian container
    Eigen::Matrix<double, 6, 6, Eigen::RowMajor> AnaliJacobian_minimal0,
    ...
    // container for analyzed jacobian
    Eigen::Matrix<double, 6, 7, Eigen::RowMajor> AnaliJacobian0,
        AnaliJacobian1,
        AnaliJacobian2,
        AnaliJacobian3;
    double *AnaliJacobians[4] = {AnaliJacobian0.data(),
                                 ...
                                 AnaliJacobian2.data(),
                                 AnaliJacobian3.data()};
    // instantialization a PoseSplineSampleError with timestamp and pose arguement
    PoseSplineSampleError *poseSplineSampleError = new PoseSplineSampleError(u, P_meas);
    poseSplineSampleError->EvaluateWithMinimalJacobians(paramters, Residual.data(),
    ...
    // evaluate residual again with perturb with noise
    poseSplineSampleError->EvaluateWithMinimalJacobians(paramters_noised, Residual.data(),
                                                        AnaliJacobians, AnaliJacobians_minimal);
    //  residual should be noisy?
    std::cout << "residual: " << Residual.transpose() << std::endl;
    // check jacobian_minimal form NumbDifferentiator manner
    ...
    /*
     * Optimization test 
     * to check whether the pose after optimization could be recovered to the original value
     */
    pose0 = pose0_noised;
    pose1 = pose1_noised;
    pose2 = pose2_noised;
    ...
    // interpolate again after optimization
    ...
    // print the optimized pose value and could be check by the initial value
