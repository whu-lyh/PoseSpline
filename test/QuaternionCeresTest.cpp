...
TEST(Ceres, QuaternionSplineCeres)
{
    ...
    Cp0 = Quaternion(-0.0233343, 0.538966, 0.805091, 0.246575);
    Cp0 = quatNorm(Cp0);
    Cp1 = Quaternion(0.142278, 0.44318, -0.513372, 0.72097);
    Cp1 = quatNorm(Cp1);
    Cp2 = Quaternion(-0.112329, 0.379688, 0.34445, 0.851219);
    Cp2 = quatNorm(Cp2);
    Cp3 = Quaternion(-0.164781, -0.303314, 0.876392, -0.335836);
    Cp3 = quatNorm(Cp3);
    ...
    std::cout << "AnaliJacobian_minimal0: " << std::endl
              << AnaliJacobian_minimal0 << std::endl;
    std::cout << "AnaliJacobian_minimal1: " << std::endl
              << AnaliJacobian_minimal1 << std::endl;
    std::cout << "AnaliJacobian_minimal2: " << std::endl
              << AnaliJacobian_minimal2 << std::endl;
    std::cout << "AnaliJacobian_minimal3: " << std::endl
              << AnaliJacobian_minimal3 << std::endl;
    ...
    std::cout << "numJacobian_min0: " << std::endl
              << numJacobian_min0 << std::endl;
    std::cout << "AnaliJacobian_minimal0*numJacobian_min0: " << std::endl
              << AnaliJacobian_minimal0 * numJacobian_min0.inverse() << std::endl;
    ...
    std::cout << "numJacobian_min1: " << std::endl
              << numJacobian_min1 << std::endl;
    std::cout << "AnaliJacobian_minimal1*numJacobian_min1: " << std::endl
              << AnaliJacobian_minimal1 * numJacobian_min1.inverse() << std::endl;
    ...
    std::cout << "numJacobian_min2: " << std::endl
              << numJacobian_min2 << std::endl;
    std::cout << "AnaliJacobian_minimal2*numJacobian_min2: " << std::endl
              << AnaliJacobian_minimal2 * numJacobian_min2.inverse() << std::endl;
    ...
    std::cout << "numJacobian_min3: " << std::endl
              << numJacobian_min3 << std::endl;
    std::cout << "AnaliJacobian_minimal3*numJacobian_min3: " << std::endl
              << AnaliJacobian_minimal3 * numJacobian_min3.inverse() << std::endl;
    ...
    std::cout << "CP0_init: " << Cp0_init.transpose() << std::endl
              << "After opt: " << Cp0.transpose() << std::endl;
    std::cout << "CP1_init: " << Cp1_init.transpose() << std::endl
              << "After opt: " << Cp1.transpose() << std::endl;
    std::cout << "CP2_init: " << Cp2_init.transpose() << std::endl
              << "After opt: " << Cp2.transpose() << std::endl;
    std::cout << "CP3_init: " << Cp3_init.transpose() << std::endl
              << "After opt: " << Cp3.transpose() << std::endl;
    ...
    std::cout << "Qmeas0: " << Q_meas.transpose() << std::endl
              << "Qhat0: " << Qhat0.transpose() << std::endl;
    std::cout << "Qmeas1: " << Q_meas1.transpose() << std::endl
              << "Qhat1: " << Qhat1.transpose() << std::endl;
    std::cout << "Qmeas2: " << Q_meas2.transpose() << std::endl
              << "Qhat2: " << Qhat2.transpose() << std::endl;
    std::cout << "Qmeas3: " << Q_meas3.transpose() << std::endl
              << "Qhat3: " << Qhat3.transpose() << std::endl;
}
//
