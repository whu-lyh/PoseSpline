...
LinearAccelerateSampleError::LinearAccelerateSampleError(const double &t_meas,
                                                         ...
                                                         const Eigen::Vector3d &a_meas) : t_meas_(t_meas), time_interval_(time_interval), a_Meas_(a_meas){

                                                                                                                                          };

LinearAccelerateSampleError::LinearAccelerateSampleError(LinearAccelerateSampleFunctor *functor) : functor_(functor)
{
}
                                                               ...
                                                               double **jacobiansMinimal) const
{
    ...
    Eigen::Vector3d a_hat = R_WI.transpose() * (Wa - G);
                                                                   ...
                                                                   double **jacobiansMinimal) const
{
    ...
    if (!jacobians)
    {
        return ceres::internal::VariadicEvaluate<
            LinearAccelerateSampleFunctor, double, 7, 7, 7, 7, 0, 0, 0, 0, 0, 0>::Call(*functor_, parameters, residuals);
    }
    bool success = ceres::internal::AutoDiff<LinearAccelerateSampleFunctor, double,
                                             7, 7, 7, 7>::Differentiate(*functor_,
                                                                        parameters,
