                                                                  ...
                                                                  double **jacobiansMinimal) const
{
    ...
    if (!jacobians)
    {
        bool success = ceres::internal::VariadicEvaluate<
            QuaternionOmegaSampleFunctor, double, 4, 4, 4, 4, 0, 0, 0, 0, 0, 0>::Call(*functor_, temp_parameters, temp_residual.data());
    ...
    double *quaternion_jacobians[4] = {quaternion_jacobian0.data(), quaternion_jacobian1.data(),
    ...
    bool success = ceres::internal::AutoDiff<QuaternionOmegaSampleFunctor, double,
                                             4, 4, 4, 4>::Differentiate(*functor_,
                                                                        temp_parameters,
