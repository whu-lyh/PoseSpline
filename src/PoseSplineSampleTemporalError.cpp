...
PoseSplineSampleTemporalError::PoseSplineSampleTemporalError(const PoseSplineSampleTemporalFunctor &functor) : functor_(functor) {}
                                                                 ...
                                                                 double **jacobiansMinimal) const
{
    if (!jacobians)
    {
        return ceres::internal::VariadicEvaluate<
            PoseSplineSampleTemporalFunctor, double, 7, 7, 7, 7, 1, 0, 0, 0, 0, 0>::Call(functor_, parameters, residuals);
    }

    bool success = ceres::internal::AutoDiff<PoseSplineSampleTemporalFunctor, double,
                                             7, 7, 7, 7, 1>::Differentiate(functor_,
                                                                           parameters,
                                                                           6,
                                                                           residuals,
                                                                           jacobians);
