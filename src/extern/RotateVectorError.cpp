...
RoatateVectorError::RoatateVectorError(double t_meas, Eigen::Vector3d originalVector,
                                       Eigen::Vector3d rotatedVector) : t_meas_(t_meas), originalVector_(originalVector),
