 ...
 * @LastEditTime: 2023-03-04 15:58:29
 * @FilePath: \PoseSpline\include\PoseSpline\QuaternionError.hpp
 * @Description: QuaternionErrorCostFunction
 */
...
public:
    ...
    // Evaluate is called internally by ceres
    ...
    bool VerifyJacobianNumDiff(double const *const *parameters)
    {
        ...
        std::cout << "Analytic Jacobian minimal: " << jacobian_minimal << std::endl;
        std::cout << "Numdiff Jacobian minimal: " << J0_numDiff << std::endl;
