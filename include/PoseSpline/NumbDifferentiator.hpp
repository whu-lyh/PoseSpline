 ...
 * @LastEditTime: 2023-03-04 21:36:15
 * @FilePath: \PoseSpline\include\PoseSpline\NumbDifferentiator.hpp
 * @Description: NumbDifferentiator class
 */
...
{
public:
    NumbDifferentiator(Functor *ptrErrorFunctor) : ptrErrorFunctor_(ptrErrorFunctor)
    {
